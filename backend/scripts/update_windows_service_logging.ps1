...
Write-Host "`nUpdating service parameters..." -ForegroundColor Cyan
...
# Check status
Write-Host "`n✅ Service updated! Checking status..." -ForegroundColor Green
nssm status $ServiceName

Write-Host "`nNew configuration:" -ForegroundColor Gray
nssm get $ServiceName AppParameters

Write-Host "`n📋 Check logs in C:\bayan\logs\backend.out.log" -ForegroundColor Cyan
