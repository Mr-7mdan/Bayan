  ...
  <AccordionPrimitive.Header className="flex">
    <AccordionPrimitive.Trigger
      ...
      className={[
        ...
        'px-0 py-2 text-xs font-semibold tracking-wide',
        // Smooth hover + cursor
        'cursor-pointer transition-colors duration-150',
        // Section headers: use secondary tint; slightly stronger on hover for feedback
        'bg-[hsl(var(--secondary)/0.6)] hover:bg-[hsl(var(--secondary))] data-[state=open]:bg-[hsl(var(--secondary)/0.6)] data-[state=open]:hover:bg-[hsl(var(--secondary))]',
    ...
    >
      ...
      <RiArrowDownSLine className="ml-2 size-4 shrink-0 text-muted-foreground transition-transform duration-150 group-data-[state=open]:rotate-180" />
    </AccordionPrimitive.Trigger>
